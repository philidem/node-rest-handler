...
REST.prototype = {
	...
	invokeRoute: function() {
		...
		// if an invoke handler is registered, use it to invoke
		// the route, otherwise invoke the route directly 
		if (this.handler.invokeHandler !== undefined) {
            this.handler.invokeHandler(this.route, this);
        }else {
