...
RESTHandler.prototype._registerRoute = function(method, route) {
    ...
    if (this.routeInfoByPath.hasOwnProperty(route)) {
        this.routeInfoByPath[route].methods.push(method);
    } else {
        this.routeInfoByPath[route] = {
            methods:[method]
        };
    }
};
...
RESTHandler.prototype.createRoute = pathBasedRouter.createRoute;
